...
#include <linux/fs.h>   // FIXME: present only for BLKGETSIZE64, maybe we can remove it? id:299 gh:300

// FIXME: Can't we find a way to do the logging in pure Go? id:329 gh:330
