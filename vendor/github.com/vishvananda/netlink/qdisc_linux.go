...
// NOTE function is here because it uses other linux functions id:714 gh:715
func NewNetem(attrs QdiscAttrs, nattrs NetemQdiscAttrs) *Netem {
	...
	// FIXME should validate values(like loss/duplicate are percentages...) id:974 gh:975
...
func qdiscPayload(req *nl.NetlinkRequest, qdisc Qdisc) error {
	...
	case *Htb:
		...
		// TODO: Handle Debug properly. For now default to 0 id:699 gh:700
