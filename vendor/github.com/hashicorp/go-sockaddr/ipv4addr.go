...
//
// NOTE: Many net.*() routines will initialize and return an IPv6 address. id:640 gh:641
...
// the network.
//
// NOTE: IPv6 only supports multicast, so this method only exists for id:529 gh:530
// IPv4Addr.
