...
func (daemon *Daemon) setupConfigDir(c *container.Container) (setupErr error) {
	...
	for _, configRef := range c.ConfigReferences {
		// TODO (ehazlett): use type switch when more are supported id:70 gh:71
...
// TODO Windows: Fix Post-TP5. This is a hack to allow docker cp to work id:813 gh:814
...
func (daemon *Daemon) setupSecretDir(c *container.Container) (setupErr error) {
	...
	for _, s := range c.SecretReferences {
		// TODO (ehazlett): use type switch when more are supported id:72 gh:73
		if s.File == nil {
